...
namespace MVC_CC9.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual IQueryable<fn_getCustomersByCountry_Result> fn_getCustomersByCountry(string country1)
        {
            var country1Parameter = country1 != null ?
                new ObjectParameter("Country1", country1) :
                new ObjectParameter("Country1", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_getCustomersByCountry_Result>("[NorthwindEntities].[fn_getCustomersByCountry](@Country1)", country1Parameter);
        }
